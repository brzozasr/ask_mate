...
To start your project click [this link](https://journey.code.cool/v2/project/team/blueprint/ask-mate-1/python), and make sure to **select or create your team**.

## Background materials

- <i class="far fa-exclamation"></i> [Understanding the web](https://learn.code.cool/full-stack/#/../pages/web/understanding-the-web)
...
![AskMate data model part 2](https://learn.code.cool/media/web-python/askmate-data-model-part-2.png)
...
To start your project click [this link](https://journey.code.cool/v2/project/team/blueprint/ask-mate-2/python), and make sure to **select or create your team**.

## Background materials

**Git:**
- <i class="far fa-exclamation"></i> [Working with the `git remote` command](https://git-scm.com/docs/git-remote)
- <i class="far fa-open_book"></i> [Merge vs rebase](https://learn.code.cool/full-stack/#/../pages/git/merge-vs-rebase)
- <i class="far fa-open_book"></i> [Mastering git](https://learn.code.cool/full-stack/#/../pages/git/mastering-git)

**SQL:**
- <i class="far fa-exclamation"></i> [Installing and setting up PostgreSQL](https://learn.code.cool/full-stack/#/../pages/tools/installing-postgresql.md)
- <i class="far fa-exclamation"></i> [Installing psycopg2](https://learn.code.cool/full-stack/#/../pages/tools/installing-psycopg2.md)
...
- <i class="far fa-open_book"></i> [PostgreSQL documentation page on Queries](https://www.postgresql.org/docs/current/queries.html)
- <i class="far fa-open_book"></i> [PostgreSQL documentation page Data Manipulation](https://www.postgresql.org/docs/current/dml.html)
...
- <i class="far fa-open_book"></i> [Planning poker](https://en.wikipedia.org/wiki/Planning_poker)

**Web basics (Flask/Jinja/HTML/CSS):**
- <i class="far fa-exclamation"></i> [Flask/Jinja Tips & Tricks](https://learn.code.cool/full-stack/#/../pages/web/web-with-python-tips.md)
- <i class="far fa-exclamation"></i> [Passing data from browser](https://learn.code.cool/full-stack/#/../pages/web/passing-data-from-browser)
...
To start your project click [this link](https://journey.code.cool/v2/project/team/blueprint/ask-mate-3/python), and make sure to **select or create your team**.
...
**SQL:**
- <i class="far fa-exclamation"></i> [Working with more complex data](https://learn.code.cool/full-stack/#/../pages/sql/sql-working-with-data)
- [SQL injection](https://learn.code.cool/full-stack/#/../pages/web-security/sql-injection)
- [Best practices for Python/Psycopg/Postgres](https://learn.code.cool/full-stack/#/../pages/python/tips-python-psycopg-postgres)
- [Date/Time handling in psycopg2](https://www.psycopg.org/docs/usage.html?highlight=gunpoint#date-time-objects-adaptation)
- <i class="far fa-open_book"></i> [PostgreSQL documentation page on Queries](https://www.postgresql.org/docs/current/queries.html)
- <i class="far fa-open_book"></i> [PostgreSQL documentation page Data Manipulation](https://www.postgresql.org/docs/current/dml.html)
- [Database glossary](https://learn.code.cool/full-stack/#/../pages/sql/database-glossary.md)
...
**Workflow:**
- <i class="far fa-exclamation"></i> [Gitflow workflow](https://learn.code.cool/full-stack/#/../pages/git/git-branching)
...
- [Flask/Jinja Tips & Tricks](https://learn.code.cool/full-stack/#/../pages/web/web-with-python-tips.md)
- [Passing data from browser](https://learn.code.cool/full-stack/#/../pages/web/passing-data-from-browser)
- <i class="far fa-open_book"></i> [HTTP is stateless](https://learn.code.cool/full-stack/#/../pages/web/authentication-http-stateless)
- <i class="far fa-open_book"></i> [Cookies](https://learn.code.cool/full-stack/#/../pages/web/authentication-cookies)
- <i class="far fa-open_book"></i> [Jinja2 documentation](https://jinja.palletsprojects.com/en/2.10.x/templates/)
- <i class="far fa-open_book"></i> [Collection of web resources](https://learn.code.cool/full-stack/#/../pages/web/resources.md)
